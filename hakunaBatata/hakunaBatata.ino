...
SoftwareSerial fingerPrint(8, 10);
#include<Servo.h>
...
void setup() 
{
   ...
   delay(1000);
    ...
    {
      Serial.println("encontrado fingerprint ");
      lcd.clear();
      lcd.print("find module ");
      delay(1000);
    } 
    else 
    {
...
void serv()
{
  ...
  {
    myservo.write(pos);
    delay(0.5); // tiempo que tarda en ir a la siguiente posicion
  }
  delay(10);
